...
$routes->match(['get', 'post'], 'admin/usuario/create', 'Usuario::create');
$routes->match(['get', 'post'], 'admin/producto/create', 'Producto::create');
...
$routes->get('close', 'Usuario::close_session');
