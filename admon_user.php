		...
		<section>
				...
				<?php
					...
					if(!isset($numcodparte)){
						...
						$sql = "SELECT ProductoId, Nombre, Descripcion, SeccionId
		                  		FROM producto";
						...
						echo "<tr><td>Numeración</td><td>Nombre</td><td>Descripción</td><td>Sección</td></tr>";
						while ($fila = mysql_fetch_array($resultado)){
							echo"				
								<tr class='producto'>
		    						...
		    						<th><input name='SeccionId[$i]' value='".$fila[3]."'/></th>
